    ...
    savepassword() async {
      ...
      String confPassword = _confpasswordController.text;
       if(newPassword != confPassword ){
        Fluttertoast.showToast(msg: "Les deux mots de pass doivent etre identique");
       }else {
          User user = User(password: newPassword);
            await users.put('current_user', user);
             Fluttertoast.showToast(msg: "ajout mot de passe reussie");
